      ...
      <div className="container mx-auto my-4">
        ...
        <div className="block md:flex">
          <div className="mx-16 pb-8">
            <Image src={aarambhposter} alt="Empower 2023" className="h-fit" />
          </div>
          <div className="h-fit my-auto">
            <div className="mx-16">
              <div className="text-lg md:text-2xl text-left lg:text-justify w-fit mx-auto">
                <p>
                  Get ready to embark on an exciting journey! Aana is excited to introduce the eagerly
                  anticipated event Empower , an introductory session designed
                  for freshers! 🌟💻
                </p>
                <br />
                <p>
                  🔍 Join us as we explore the fascinating world of legal consultation and representation for women who cannot afford it.{" "}
                </p>
                <br />
              </div>
            </div>

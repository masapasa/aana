          ...
          <div className="h-fit my-auto">
            <div className="mx-16">
              <div className="text-lg md:text-2xl text-left lg:text-justify w-fit mx-auto">
                <p>
                  We'll show you how To carry out surveys to identify the legal problems faced by women.
                  <br />
                  This event is perfect for all the people interested in safe space.
                </p>
                <br />
              </div>
            </div>
